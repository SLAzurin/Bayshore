  ...
  register(app: Application): void {
    ...
    app.post("/method/search_cars_by_level", async (req, res) => {
      ...
      while (arr.length < maxNumber) {
        ...
        if (arr.indexOf(randomNumber) === -1) {
          ...
          if (!ghost_trails) {
            lists_ghostcar.push(
              wm.wm.protobuf.GhostCar.create({
      ...
      if (
        ...
        if (car.length < 1) {
          ...
          let ghost_default_cars =
            await ghost_default_car.DefaultGhostCarHonda();
      ...
      let msg = {
        ...
        selectionMethod: Number(
          wm.wm.protobuf.GhostSelectionMethod.GHOST_SELECT_BY_LEVEL
        ),
      };
    ...
    app.post("/method/search_cars", async (req, res) => {
      ...
      switch (body.selectionMethod) {
        ...
        case wm.wm.protobuf.GhostSelectionMethod
        ...
        case wm.wm.protobuf.GhostSelectionMethod
          .GHOST_SELECT_BY_REGION_MANUFACTURER: {
          let selectManufacturer = body.selectManufacturer;
      ...
      if (car.length === 0) {
        if (
          body.selectionMethod ===
            wm.wm.protobuf.GhostSelectionMethod.GHOST_SELECT_BY_MANUFACTURER ||
          body.selectionMethod ===
            wm.wm.protobuf.GhostSelectionMethod
              .GHOST_SELECT_BY_OTHER_MANUFACTURER ||
          body.selectionMethod ===
            wm.wm.protobuf.GhostSelectionMethod
              .GHOST_SELECT_BY_REGION_MANUFACTURER
          ...
          if (body.selectManufacturer === 0) {
            // BMW (Blood, Memory, Wonichan Moe)
            ghost_default_cars = await ghost_default_car.DefaultGhostCarBMW();
          } else if (body.selectManufacturer === 1) {
            // CHEVROLET
            ghost_default_cars =
              await ghost_default_car.DefaultGhostCarChevrolet();
          } else if (body.selectManufacturer === 2) {
            // MAZDA
            ...
            ghost_default_cars =
              await ghost_default_car.DefaultGhostCarMercedes();
          } else if (body.selectManufacturer === 4) {
            // MITSUBISHI
            // TODO: default car here
            ghost_default_cars =
              await ghost_default_car.DefaultGhostCarMitsubishi();
          } else if (body.selectManufacturer === 5) {
            // NISSAN
            ghost_default_cars =
              await ghost_default_car.DefaultGhostCarNissan();
          } else if (body.selectManufacturer === 7) {
            ...
            // TODO: default car here
            ghost_default_cars =
              await ghost_default_car.DefaultGhostCarSubaru();
          } else if (body.selectManufacturer === 8) {
            // TOYOTA
            ghost_default_cars =
              await ghost_default_car.DefaultGhostCarToyota();
          ...
          } else if (body.selectManufacturer === 11) {
            // LAMBORGHINI
            ghost_default_cars =
              await ghost_default_car.DefaultGhostCarLamborghini();
          } else if (body.selectManufacturer === 12) {
            // HONDA
            ghost_default_cars = await ghost_default_car.DefaultGhostCarHonda();
          } else if (body.selectManufacturer === 13) {
            // ACURA
            ghost_default_cars = await ghost_default_car.DefaultGhostCarAcura();
          } else if (body.selectManufacturer === 14) {
            // PORSCHE
            ghost_default_cars =
              await ghost_default_car.DefaultGhostCarPorsche();
          } // OTHER MAYBE?
          else {
            ghost_default_cars = await ghost_default_car.DefaultGhostCarHonda();
          }
    ...
    app.post("/method/load_ghost_drive_data", async (req, res) => {
      ...
      for (let i = 0; i < body.carTunings.length; i++) {
        ...
        if (
          ghost_trails?.driveData !== null &&
          ghost_trails?.driveData !== undefined
        ) {
        ...
        if (
          ghost_trails?.trendBinaryByArea !== null &&
          ghost_trails?.trendBinaryByArea !== undefined
        ) {
        ...
        if (
          ghost_trails?.trendBinaryByCar !== null &&
          ghost_trails?.trendBinaryByCar !== undefined
        ) {
        ...
        if (
          ghost_trails?.trendBinaryByUser !== null &&
          ghost_trails?.trendBinaryByUser !== undefined
        ) {
        ...
        // Push the data
        lists_ghostcar.push(
          wm.wm.protobuf.LoadGhostDriveDataResponse.GhostDriveData.create({
            // Push the data
    ...
    app.post("/method/register_ghost_trail", async (req, res) => {
      ...
      // Ghost Battle or Crown Ghost Battle game Mode session id
        ...
        if (
          !body.trendBinaryByArea &&
          !body.trendBinaryByCar &&
          !body.trendBinaryByUser
        ) {
      ...
      for (let j = 0; j < 19; j++) {
        ...
        for (let i = 0; i < body.selectedCars.length; i++) {
          ...
          if (pathAndTuning) {
            // Push the data
            carTuning.push(
              wm.wm.protobuf.CarTuning.create({
                carId: body.selectedCars[i],
        ...
        // Push the data
        carTbyP.push(
          wm.wm.protobuf.LoadPathsAndTuningsResponse.CarTuningsByPath.create({
            area: j,
            ramp: rampVal,
            path: pathVal,
