  ...
  register(app: Application): void {
    ...
    app.post("/method/load_car", async (req, res) => {
      ...
      let msg = {
        ...
        ghostExpeditionState:
          wm.wm.protobuf.GhostExpeditionParticipantState
            .EXPEDITION_NOT_PARTICIPATED,
      };
    ...
    app.post("/method/create_car", async (req, res) => {
      ...
      if (body.userItemId) {
        ...
        console.log(
          `Item category was ${item.category} and item game ID was ${item.itemId}`
        );
      }
      ...
      // User item not used, but car has 600 HP by default
        ...
        body.car &&
        body.car.tunePower == 10 &&
        body.car.tuneHandling == 10
      ) {
        // Car is basic tuned
        tune = 1;
      }
